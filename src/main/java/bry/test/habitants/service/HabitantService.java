...
import bry.test.habitants.integration.ViaCepIntegration;
import bry.test.habitants.model.Address;
import bry.test.habitants.model.Habitant;
import bry.test.habitants.repository.AddressRepository;
import bry.test.habitants.repository.HabitantRepository;
