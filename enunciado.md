...
3. Faça um *fork* do projeto [desafio-backend-pleno](https://gitlab.com/brytecnologia/selecao/desafio-backend-pleno) - isso criará um projeto idêntico no seu repositório pessoal.
